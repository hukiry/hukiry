Shader "YueChuan/RimLight/RimLightFloatRayOnePass" 
{
    Properties 
	{
        ...
        Pass 
        {
            ...
            VS_OUTPUT MainVS(appdata_base input)
            {
                ...
                if (_IsRimLight)
                {
                    ...
                    output.v4RimColor = pow((1.0 - dot(vEyeDir,v3WNormal)),2) * _RimColor * _Attenuation;
                }
                return output;
            }
            ...
            {
                fixed4 v4MainTex = tex2D(_MainTex,input.v2MainUV) * _Color;
				...
				return v4FloatRayTex * _ColorWeight.x + v4ReflectTex * _ColorWeight.y + v4MainTex * _ColorWeight.z + input.v4RimColor;
            }

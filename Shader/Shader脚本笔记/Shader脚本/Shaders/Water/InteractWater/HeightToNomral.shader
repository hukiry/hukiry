//第三步
Shader "YueChuan/InteractWater/HeightToNomral" 
{
    Properties 
	{
    ...
    SubShader 
    {
        ...
        Pass 
        {
            ...
            half DecodeHeightmap(half4 heightmap)
            {

		        half4 table = half4(1.0f, -1.0f, 1.0f/256.0f, -1.0f/256.0f);
            ...
            {   
	            ...
	            half3 n = half3(fHeightB - fHeightT, fHeightR - fHeightL, 0.1);

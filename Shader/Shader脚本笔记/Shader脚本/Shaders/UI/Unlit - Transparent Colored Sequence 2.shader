Shader "Hidden/Unlit/Transparent Colored Sequence 2"
{
    Properties
    {
    ...
    #include "UnityCG.cginc"
            ...
            v2f vert(appdata_t v)
            {
                ...
                o.worldPos.xy = worldPos.xy * _ClipRange0.zw + _ClipRange0.xy;
                o.worldPos.zw = Rotate(worldPos.xy, _ClipArgs1.zw) * _ClipRange1.zw + _ClipRange1.xy;
                return o;
            }

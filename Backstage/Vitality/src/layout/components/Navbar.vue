    ...
    <div class="right-menu">
      <template v-if="device!=='mobile'">
        ...
        <el-dropdown class="avatar-container right-menu-item hover-effect" >
          <div  class="avatar-wrapper"> {{ "时间:"+getTextTime(nowtime,"{y}年{m}月{d}日 {h}时{i}分{s}秒")  }}</div>
          <!-- <div class="avatar-wrapper">
            test
          </div> 
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>test1</el-dropdown-item>
            <el-dropdown-item divided @click.native="1">
      ...
      <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
        ...
        <el-dropdown-menu slot="dropdown">
          <a target="_blank" href="https://panjiachen.github.io/">
            <el-dropdown-item>文 档</el-dropdown-item>
          </a>
